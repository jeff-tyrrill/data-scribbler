/*
 * Modified slightly for Data Scribbler by Jeff Tyrrill,
 * based on:
 *
 * https://github.com/s3u/JSONPath/blob/master/lib/jsonpath.js
 * which is a fork of:
 * 
...
JSONPath.prototype._eval = function (code, _v, _vname, path, parent, parentPropName) {
    if ((' ' + code).match(/[^.\'\"@a-zA-Z0-9_$][a-zA-Z_$][a-zA-Z0-9]*/g) || code.match(/\.prototype/g)) {
        throw new Error('jsonPath: query not executed because filter contains possibly unsafe code: ' + code);
    }
